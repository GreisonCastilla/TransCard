<script setup >
  ...
  const {collection, addCard} = useCard()

  //console.log(cards)
  //addCard(12309, 'Primera');
  ...
  async function startScan() {
    if (!isPlatform('capacitor')) {
      alert('Este escáner solo funciona en dispositivos móviles.')
      return
    }
